...
const About = () => {
  return (
    <section id="about" className="min-h-screen bg-[var(--section-bg)] px-6 md:px-16 pt-16 scroll-mt-16">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-[var(--color-foreground)] text-3xl md:text-4xl font-bold mb-8 relative inline-block">
          About Me
          <div className="h-1 w-16 bg-[var(--accent)] mt-2"></div>
        </h2>
        ...
        <div className="flex flex-col md:flex-row gap-12 mt-12">
          ...
          <div className="flex-1 text-[var(--slate)]">
